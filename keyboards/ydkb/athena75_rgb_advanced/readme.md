...
| **BRICK** | Breakout 打砖块屏保（Arkanoid 式砖型）：10×10、AI 挡板、随机胶囊（约 1/3 碎砖掉落） | 每关随机：彩色/银砖分界（4–6 行）、配色旋转、4–6 块金砖（不同列）、0–10 个空洞；通关后进下一关布局再变。自动演示；**↑↓** 调速；Enter = SPEED；Space 重开。胶囊带字母：E 加长、N 缩短、D 多球、S 减速、F 加速、C 粘球、L 穿砖 |
